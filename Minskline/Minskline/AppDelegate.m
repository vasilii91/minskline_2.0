...
static NSString * const databaseName = @"Minskline.sqlite";
...
//    {
//		NSString *defaultStorePath = [[NSBundle mainBundle] pathForResource:[databaseName stringByDeletingPathExtension] ofType:[databaseName pathExtension]];
//        
//		if (defaultStorePath)
//        {
//            NSError *error;
...
//    }
//    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Minskline" withExtension:@"momd"];
