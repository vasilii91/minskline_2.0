...
- (void)viewDidLoad {
    ...
    UIImage* mailImage2 = [UIImage imageNamed:@"/Bundle.bundle/Resources/rosetta_mail.png"];
    UIImage* mailImage3 = [UIImage imageNamed:@"/Bundle.bundle/Resources/rosetta_mail.png"];
    ...
    AURosetteItem* mailItem2 = [[AURosetteItem alloc] initWithNormalImage:mailImage2
                                                        highlightedImage:nil
                                                                  target:self
                                                                  action:@selector(mailAction:)];
    
    AURosetteItem* mailItem3 = [[AURosetteItem alloc] initWithNormalImage:mailImage3
                                                         highlightedImage:nil
                                                                   target:self
                                                                   action:@selector(mailAction:)];

    // create rosette view
    AURosetteView* rosette = [[AURosetteView alloc] initWithItems: [NSArray arrayWithObjects: twitterItem, facebookItem, mailItem, mailItem2, mailItem3, nil]];
